...
| Key                  | Description                                                                                          | Format                                                 | Examples                                                                                    |
|----------------------|------------------------------------------------------------------------------------------------------|--------------------------------------------------------|---------------------------------------------------------------------------------------------|
| `audio`              | The language code of the current audio track                                                         | String (use standards like ISO or BCP 47)              | `en`                                                                                        |
...
| `subtitles`          | The language code of the subtitles currently being displayed                                         | String (use standards like ISO or BCP 47)              | `en`                                                                                        |
